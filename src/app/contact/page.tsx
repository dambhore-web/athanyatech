...
const nextSteps = [
  {
    ...
    description:
      "Every inquiry gets a real person reading it — not an automated response.",
  },
  {
    number: "2",
    title: "We call or email within 24 hours",
    description:
      "We'll reach out to understand your needs better and answer any questions you have.",
  },
  {
    number: "3",
    title: "You get a free, no-obligation quote",
    description:
      "A clear breakdown of what we'll build and what it costs. No pressure, no hidden fees.",
  },
];
...
export default function ContactPage() {
  return (
    <>
      <section
        className="bg-brand-dark pt-32 pb-16"
        ...
        <div className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div>
              ...
              <ul className="space-y-6 mt-4">
                {nextSteps.map((step) => (
                  <li key={step.number} className="flex items-start gap-4">
                    <div className="w-8 h-8 rounded-full bg-brand-gold flex items-center justify-center shrink-0 mt-0.5">
            ...
            <div className="bg-brand-surface rounded-lg p-6">
              <p className="font-display font-semibold text-xs uppercase tracking-widest text-brand-slate mb-4">
                Prefer to reach out directly?
              </p>
              <a
                href="mailto:hello@athanyatechnologies.com"
                className="text-brand-indigo font-display font-semibold hover:text-brand-gold transition-colors block mb-2"
              >
